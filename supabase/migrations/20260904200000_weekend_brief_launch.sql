-- Weekend Brief LAUNCH (2026-09-04): the preview gate comes off. David approved
-- the brief after two Friday previews; the push now goes to every premium user
-- with the weekend_brief preference on (still composed from their own follows).
-- Identical to 20260826190000 except the brief branch no longer requires
-- pr.is_admin.
